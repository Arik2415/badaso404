...
<html lang="en">
  <head>
    ...
    <title>UTS Back-end | Table</title>
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/" class="brand-link">
          <img
            ...
            style="opacity: 0.8"
          />
          <span class="brand-text font-weight-light">UTS Back-end</span>
        </a>
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img
                src="{{asset('AdminLTE')}}/dist/img/bagas.png"
                class="img-circle elevation-2"
                alt="User Image"
              />
            </div>
            <div class="info">
              <a href="#" class="d-block">Bagas Pratama</a>
            </div>
          </div>
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active">Table Utama</li>
                  <li class="breadcrumb-item"><a href="/sesi/logout">logout</a></li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <table class="table table">
            <thead>
                <tr>
                    ...
                    <th class="col-md-1">Jenis Pegawai</th>
                    <th class="col-md-1">Status Pegawai</th>
                    <th class="col-md-1">Unit</th>
                    <th class="col-md-1">Sub.Unit</th>
                    <th class="col-md-1">Pendidikan</th>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  @if ($value->foto)
                      <img style="max-width:50px; max-height:30px" src="{{ url('foto')."/".$value->foto }}"/>
                  @endif
                </td>
                <td>{{ $value->nama }}</td>
                <td>{{ $value->nik }}</td>
                ...
                <td>{{ $value->agama }}</td>
                <td class="d-flex">
                    <a href='{{ route('edit', ['id' => $value->id]) }}' class="btn btn-warning btn-sm">Edit</a>
