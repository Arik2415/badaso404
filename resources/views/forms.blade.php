...
<html lang="en">
  <head>
    ...
    <title>UTS Back-End | Forms</title>
                ...
                <div class="card card-primary">
                  ...
                  <form action="/table" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="sub_unit" value="{{ old('sub_unit') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="agama" class="form-control" >
                        ...
                        @foreach ($agama as $item)
                          <option value="{{$item->nama_agama}}">{{ $item->nama_agama }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="form-group">
